...
typedef NS_ENUM(NSInteger, RecaptchaErrorCode) {
   ...
   * [Create Key](https://cloud.google.com/recaptcha/docs/create-key).
   */
   ...
   * [action guidelines](https://cloud.google.com/recaptcha/docs/actions-mobile).
   */
  RecaptchaErrorInvalidAction = 5,

  /**
   * reCAPTCHA cannot accept timeout provided, see
   * [timeout guidelines](https://cloud.google.com/recaptcha/docs/instrument-ios-apps#timeout).
   */
